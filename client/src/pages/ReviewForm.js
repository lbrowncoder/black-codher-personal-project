                          ...
                          <form onSubmit={(event) => handleSubmit(event)}>
                            ...
                            <div className='rateOverall'>
                                ...
                                <p className="points">Overall Standard</p>
                                  <ToggleButtonGroup className="ratingForm" type="checkbox" value={standard} size="sm" onChange={onclick}>
                                    <ToggleButton value={1}>Very Poor</ToggleButton>
                                    <ToggleButton value={2}>Poor</ToggleButton>
                                    <ToggleButton value={3}>Satisfactory</ToggleButton>
                                    <ToggleButton value={4}>Good</ToggleButton>
                              ...
                              <p className="points"Two>Facilities/Outdoor Space</p>
                                  <ToggleButtonGroup className="ratingForm" type="checkbox" value={outdoor} size="sm" onChange={onclick}>
                                      <ToggleButton value={1}>Very Poor</ToggleButton>
                                      <ToggleButton value={2}>Poor</ToggleButton>
                                      <ToggleButton value={3}>Satisfactory</ToggleButton>
                                      <ToggleButton value={4}>Good</ToggleButton>
                              ...
                              <p className="points">Learning</p>
                                  <ToggleButtonGroup className="ratingForm" type="checkbox" value={learning} size="sm" onChange={onclick}>
                                    <ToggleButton value={1}>Very Poor</ToggleButton>
                                    <ToggleButton value={2}>Poor</ToggleButton>
                                    <ToggleButton value={3}>Satisfactory</ToggleButton>
                                    <ToggleButton value={4}>Good</ToggleButton>
                              ...
                              <p className="points">Recources/ICT</p>
                                  <ToggleButtonGroup className="ratingForm" type="checkbox" value={ict} size="sm" onChange={onclick}>
                                    <ToggleButton value={1}>Very Poor</ToggleButton>
                                    <ToggleButton value={2}>Poor</ToggleButton>
                                    <ToggleButton value={3}>Satisfactory</ToggleButton>
                                    <ToggleButton value={4}>Good</ToggleButton>
                              ...
                              <p className="points">Care</p>
                                  <ToggleButtonGroup className="ratingForm" type="checkbox" value={care} size="sm" onChange={onclick}>
                                    <ToggleButton value={1}>Very Poor</ToggleButton>
                                    <ToggleButton value={2}>Poor</ToggleButton>
                                    <ToggleButton value={3}>Satisfactory</ToggleButton>
                                    <ToggleButton value={4}>Good</ToggleButton>
                              ...
                              <p className="points">Activites</p>
                                  <ToggleButtonGroup className="ratingForm" type="checkbox" value={activities} size="sm" onChange={onclick}>
                                    <ToggleButton value={1}>Very Poor</ToggleButton>
                                    <ToggleButton value={2}>Poor</ToggleButton>
                                    <ToggleButton value={3}>Satisfactory</ToggleButton>
                                    <ToggleButton value={4}>Good</ToggleButton>
                              ...
                              <p className="points">Staff</p>
                                  <ToggleButtonGroup className="ratingForm" type="checkbox" value={staff} size="sm" onChange={onclick}>
                                    <ToggleButton value={1}>Very Poor</ToggleButton>
                                    <ToggleButton value={2}>Poor</ToggleButton>
                                    <ToggleButton value={3}>Satisfactory</ToggleButton>
                                    <ToggleButton value={4}>Good</ToggleButton>
                              ...
                              <p className="points">Food/Nutrition</p>
                                  <ToggleButtonGroup className="ratingForm" type="checkbox" value={food} size="sm" onChange={onclick}>
                                    <ToggleButton value={1}>Very Poor</ToggleButton>
                                    <ToggleButton value={2}>Poor</ToggleButton>
                                    <ToggleButton value={3}>Satisfactory</ToggleButton>
                                    <ToggleButton value={4}>Good</ToggleButton>
                              ...
                              <p className="points">Management</p>
                                  <ToggleButtonGroup className="ratingForm" type="checkbox" value={managment} size="sm" onChange={onclick}>
                                    <ToggleButton value={1}>Very Poor</ToggleButton>
                                    <ToggleButton value={2}>Poor</ToggleButton>
                                    <ToggleButton value={3}>Satisfactory</ToggleButton>
                                    <ToggleButton value={4}>Good</ToggleButton>
                              ...
                              <p className="points">Cleanliness</p>
                                  <ToggleButtonGroup className="ratingForm" type="checkbox" value={clean} size="sm" onChange={onclick}>
                                    <ToggleButton value={1}>Very Poor</ToggleButton>
                                    <ToggleButton value={2}>Poor</ToggleButton>
                                    <ToggleButton value={3}>Satisfactory</ToggleButton>
                                    <ToggleButton value={4}>Good</ToggleButton>
                              ...
                              <p className="points">Safeguarding</p>
                                  <ToggleButtonGroup className="ratingForm" type="checkbox" value={safe} size="sm" onChange={onclick}>
                                    <ToggleButton value={1}>Very Poor</ToggleButton>
                                    <ToggleButton value={2}>Poor</ToggleButton>
                                    <ToggleButton value={3}>Satisfactory</ToggleButton>
                                    <ToggleButton value={4}>Good</ToggleButton>
                              ...
                              <p className="points">Value for money</p>
                                  <ToggleButtonGroup className="ratingForm" type="checkbox" value={money} size="sm" class="btn btn-default" onChange={onclick}>
                                    <ToggleButton value={1}>Very Poor</ToggleButton>
                                    <ToggleButton value={2}>Poor</ToggleButton>
                                    <ToggleButton value={3}>Satisfactory</ToggleButton>
                                    <ToggleButton value={4}>Good</ToggleButton>
